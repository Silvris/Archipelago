...
mm4_regions: dict[str, RegionData] = {
    ...
    "Dr. Cossack's Fortress 2": RegionData({
        ...
        names.cossack_2_c1: LocationData(0x0217, energy=True),
        names.cossack_2_c2: LocationData(0x0218, energy=True),
        names.cossack_2_c3: LocationData(0x0219, energy=True),
        names.cossack_2_c4: LocationData(0x021A, energy=True),
        names.cossack_2_c5: LocationData(0x021B, energy=True),
        names.cossack_2_c6: LocationData(0x021C, energy=True),
        names.cossack_2_c7: LocationData(0x021D, oneup_tank=True),
        names.cossack_2_c8: LocationData(0x021E, oneup_tank=True),
    }, [names.cossack_2_stage], []),

    "Dr. Cossack's Fortress 3": RegionData({
        names.cossack_3_boss: LocationData(0x0011),
        names.cossack_3_c1: LocationData(0x021F, energy=True),
        names.cossack_3_c2: LocationData(0x0220, energy=True),
        names.cossack_3_c3: LocationData(0x0221, energy=True),
        names.cossack_3_c4: LocationData(0x0222, oneup_tank=True),
    }, [names.cossack_3_stage], []),

    "Dr. Cossack's Fortress 4": RegionData({
        names.cossack_4_boss: LocationData(0x0012),
        names.cossack_4_c1: LocationData(0x0223, energy=True),
        names.cossack_4_c2: LocationData(0x0224, energy=True),
        names.cossack_4_c3: LocationData(0x0225, oneup_tank=True),
        names.cossack_4_c4: LocationData(0x0226, energy=True),
        names.cossack_4_c5: LocationData(0x0227, oneup_tank=True),
        names.cossack_4_c6: LocationData(0x0228, energy=True),
        names.cossack_4_c7: LocationData(0x0229, energy=True),
        names.cossack_4_c8: LocationData(0x022A, energy=True),
    }, [names.cossack_4_stage], []),

    "Wily Stage 1": RegionData({
        names.wily_1_boss: LocationData(0x0013),
        names.wily_1_c1: LocationData(0x022B, energy=True),
        names.wily_1_c2: LocationData(0x022C, energy=True),
        names.wily_1_c3: LocationData(0x022D, energy=True),
        names.wily_1_c4: LocationData(0x022E, oneup_tank=True),
    ...
    "Wily Stage 3": RegionData({
        ...
        names.wily_3_c1: LocationData(0x0231, oneup_tank=True),
        names.wily_3_c2: LocationData(0x0232, oneup_tank=True),
        names.wily_3_c3: LocationData(0x0233, energy=True),
        names.wily_3_c4: LocationData(0x0234, energy=True),
        names.wily_3_c5: LocationData(0x0235, energy=True),
        names.wily_3_c6: LocationData(0x0236, energy=True),
        names.wily_3_c7: LocationData(0x0237, energy=True),
        names.wily_3_c8: LocationData(0x0238, energy=True),
        names.wily_3_c9: LocationData(0x0239, energy=True),
        names.wily_3_c10: LocationData(0x023A, energy=True),
        names.wily_3_c11: LocationData(0x023B, energy=True),
        names.wily_3_c12: LocationData(0x023C, energy=True),
        names.wily_3_c13: LocationData(0x023D, energy=True),
