...
from .names import (RUBY_BOARD, SAPPHIRE_BOARD, AREAS, EXTRA_STARTING_LIFE, STARTING_COINS, STARTING_BALL_MODIFIER,
                    PICHU_UPGRADE, SPECIAL_GUESTS, ENCOUNTER_RATE_UP, RUINS_AREA_CARD)
...
MAIN_ITEMS: dict[str, ItemData] = {
    ...
    EXTRA_STARTING_LIFE: ItemData(3, ItemClassification.progression),
    STARTING_COINS: ItemData(4, ItemClassification.progression),
    STARTING_BALL_MODIFIER: ItemData(5, ItemClassification.useful),
...
AREA_ITEMS: dict[str, ItemData] = {
    area: ItemData(10 + idx, ItemClassification.progression) for idx, area in AREAS.items()
}
