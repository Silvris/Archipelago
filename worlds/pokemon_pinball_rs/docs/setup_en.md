# Pokémon Pinball Ruby & Sapphire Setup Guide

## Required Software

- [Archipelago](https://github.com/ArchipelagoMW/Archipelago/releases)
- An English Pokémon Pinball Ruby & Sapphire ROM.
...
This will generate an output file for you. Your patch file will have the `.appbrs` file extension.
...
1. Pokémon Pinball Ruby & Sapphire uses Archipelago's BizHawk Client. If the client isn't still open from when you patched your game,
...
connected and recognized Pokémon Pinball Ruby & Sapphire.
