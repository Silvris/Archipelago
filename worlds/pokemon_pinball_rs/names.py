...
SPECIAL_GUESTS = "e-Reader Card - Special Guests"
ENCOUNTER_RATE_UP = "e-Reader Card - Encounter Rate Up"
DX_MODE = "e-Reader Card - DX Mode"  # Not going to use, we want to hijack it for randomization
RUINS_AREA_CARD = "e-Reader Card - Ruins Area"
...
POKEDEX_MEDAL = "Pokédex Medal"
ALWAYS_OPEN_SHOPS = "24/7 Shops"
...
EGG_BUNCH_FOREST = "Egg Bunch (Forest)"
EGG_BUNCH_CAVE = "Egg Bunch (Cave)"
EGG_BUNCH_MOUNTAIN = "Egg Bunch (Mountain)"
EGG_BUNCH_DESERT = "Egg Bunch (Desert)"
EGG_BUNCH_SEA = "Egg Bunch (Sea)"
