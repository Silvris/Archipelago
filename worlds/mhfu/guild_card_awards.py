...
guild_card_awards: dict[str, GuildCardAward] = {
    ...
    "Village Chief's Hat": GuildCardAward(award_start + 2, village=(0, 3), quests=["m10206", "m10207", "m10209",
                                                                                   "m10304", "m10308", "m10309",
                                                                                   "m10318"]),
    ...
    "Gold Medal": GuildCardAward(award_start + 11, guild=(2, 2), quests=["m02124", "m02228", "m02229", "m02214",
                                                                         "m02215", "m02217", "m02218", "m02219",
                                                                         "m02220", "m02221", "m02222", "m02225",
                                                                         "m02226"]),
    "Black Belt Badge": GuildCardAward(award_start + 12, training=True, quests=[f"m210{i:02}"
                                                                                for i in [*range(1, 11),
                                                                                          *range(16, 24)]]),
    ...
    "Sage's Bracelet": GuildCardAward(award_start + 22, monster=["Crimson Fatalis"], grindy=True),
    # ???????????? trusting JP guide here
    "Wyverian Artisan's Hammer": GuildCardAward(award_start + 23, grindy=True),
    "Hunter's Progress": GuildCardAward(award_start + 24, area=[11, 20, 21, 6, 17, 3, 4, 18, 5, 19, 2, 16, 13, 15, 14],
                                        grindy=True),
    ...
    "Gold Shield": GuildCardAward(award_start + 31, guild=(3, 2), quests=["m03127"]),
    # little hack here, only locked GR optionals have the Lao as a requirement
    "Supreme Hunter's Crest": GuildCardAward(award_start + 32, guild=(3, 2), village=(1, 2), grindy=True,
                                             quests=["m03127", "m11226"]),
    ...
    "Letter to my Fearless Leader": GuildCardAward(award_start + 45, guild=(3, 2), grindy=True),
    # not really but its very time consuming
