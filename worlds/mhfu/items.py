...
weapon_item_table: dict[str, ItemData] = {
    "Progressive Great Sword/Long Sword": ItemData(24700000, True),
...
armor_item_table: dict[str, ItemData] = {
...
progression_item_table: dict[str, ItemData] = {
...
trap_item_table: dict[str, ItemData] = {
    ...
    "Poisontoad": ItemData(24700512, False, trap=True),
    "Sleeptoad": ItemData(24700513, False, trap=True),
